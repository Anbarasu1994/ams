...
function Courses() {
  return (
    <div id="courses-education" className="courses-wrap">
      <div className="courses-container">
        <h2>Explore Our Education Programs</h2>
        <p>
          Annai College of Education is dedicated to providing a diverse range of undergraduate (UG) and postgraduate (PG) programs in the field of education, offering students the opportunity to achieve their academic and career goals in the realm of teaching and education.
        </p>
